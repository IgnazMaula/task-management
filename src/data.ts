export const TaskData = {
    Tasks: [
        { title: 'Fresh Desk', closeDate: 'May 22, 2022', name: 'Lindsey Stroud', status: 'Urgent', taskType: 'Task' },
        { title: 'Skype', closeDate: 'May 28, 2022', name: 'George Fields', status: 'Default', taskType: 'Task' },
        {
            title: 'Netflix',
